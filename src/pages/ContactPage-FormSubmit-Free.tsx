...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // FormSubmit sends the enquiry to AVRX and the _autoresponse
      // field sends a confirmation email back to the client.
      payload.append('_subject', `New AVRX Website Enquiry - ${formData.service}`);
...
support@avrx.in`
      ...
      const response = await fetch('https://formsubmit.co/ajax/support@avrx.in', {
        method: 'POST',
        body: payload,
        headers: {
