          ...
          <div className="lg:col-span-4 space-y-2 sticky top-28">
            ...
            {INSURANCE_SERVICES.map(svc => (
              ...
              >
                ...
                <ArrowRight className={`w-4 h-4 shrink-0 ${selectedService?.id === svc.id ? 'text-purple-400' : 'text-slate-600'}`} />
              </button>
            ))}
          </div>
              ...
              {selectedService.imageUrl && (
                <div className="relative h-48 sm:h-56 w-full rounded-2xl overflow-hidden border border-slate-800">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                    <div className="flex items-center gap-2 px-3 py-1 rounded-lg bg-slate-950/80 backdrop-blur-md border border-slate-700/80 text-purple-300 text-xs font-semibold">
