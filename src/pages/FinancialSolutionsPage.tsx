            ...
            {FINANCIAL_SERVICES.map(svc => (
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  <div className="p-2 rounded-xl bg-slate-950 border border-slate-800 text-emerald-400 shrink-0">
                ...
                <ArrowRight className={`w-4 h-4 shrink-0 ${selectedService?.id === svc.id ? 'text-emerald-400' : 'text-slate-600'}`} />
              </button>
            ))}
          </div>
              ...
              {selectedService.imageUrl && (
                <div className="relative h-48 sm:h-56 w-full rounded-2xl overflow-hidden border border-slate-800">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                    <div className="flex items-center gap-2 px-3 py-1 rounded-lg bg-slate-950/80 backdrop-blur-md border border-slate-700/80 text-emerald-300 text-xs font-semibold">
