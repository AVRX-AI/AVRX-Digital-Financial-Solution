  ...
  <div class="wrapper">
    <div class="main-card">
      ...
      <div class="content">
        ...
        <p class="text-body">
          We have successfully received your enquiry regarding <strong>${cleanService}</strong>. Our assigned domain specialist is currently reviewing your requirement and will contact you shortly via phone or email.
        </p>
    ...
    <div class="card">
      ...
      <div class="content">
        ...
        <div class="info-grid">
          ...
          <div class="info-row"><span class="info-label">Mobile Number:</span> <span class="info-val"><a href="tel:${cleanPhone.replace(/\s+/g, '')}" style="color: #34d399;">${cleanPhone}</a></span></div>
          <div class="info-row"><span class="info-label">City / Location:</span> <span class="info-val">${cleanLocation}</span></div>
        </div>
        ...
        <div class="info-grid">
          ...
          <div class="info-row"><span class="info-label">Lead Status:</span> <span class="info-val" style="color: #34d399;">New (Saved in Lead Database)</span></div>
        </div>
...
export function generateAdminNotificationText(lead: LeadData): string {
  return `NEW WEBSITE ENQUIRY LEAD — AVRX PLATFORM
...
- Email: ${lead.email}
- Mobile: ${lead.phone}
- City/Location: ${lead.location || 'Not Specified'}
...
- Status: New (Saved in Lead Database)
==================================================
