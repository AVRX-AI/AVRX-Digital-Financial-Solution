    ...
    <>
      ...
      <div className="fixed bottom-20 md:bottom-6 left-4 sm:left-6 z-40">
        ...
        >
          ...
          <div className="relative w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-cyan-500/20 border border-cyan-400/50 flex items-center justify-center text-cyan-300">
          ...
          <div className="relative text-left pr-1 hidden xs:block">
            ...
            <div className="text-[8px] sm:text-[9px] text-cyan-300 font-mono tracking-wider">AI ASSISTANT</div>
          </div>
        </button>
      </div>
