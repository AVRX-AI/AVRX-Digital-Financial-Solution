...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 group flex items-center gap-2.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-semibold px-4 py-3 rounded-full shadow-[0_4px_25px_rgba(16,185,129,0.4)] transition-all duration-300 hover:scale-105 active:scale-95"
    >
